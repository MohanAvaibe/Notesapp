...
export const NotesScreen = ({ navigation }) => {
  ...
  return (
    <SafeArea>
      ...
      {/* plus icon on home screen to navigate to edit note screen */}
      <FAB
        small
        icon="plus"
        color="white"
        onPress={() => {
          setAbVisible(!abVisible);
        }}
        style={{
          zIndex: 999,
          position: "absolute",
